...
{
    [Tooltip("Prefab rigidbody to spawn")][SerializeField]
    private Rigidbody2D bullet;

    [Tooltip("Empty object location to fire from")][SerializeField]
    private Transform barrel;

    [Tooltip("Bullet speed (Default: 500)")][Range(0f, 1000f)]
    [SerializeField] private float bulletSpeed = 500f;

    [Tooltip("Cooldown in seconds")][Range(0f, 10f)]
